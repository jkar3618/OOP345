...
namespace seneca
{
	...
	Rogue<T, FirstAbility_t, SecondAbility_t>::Rogue(const char* name, int healthMax, int baseAttack, int baseDefense):CharacterTpl(name, healthMax), m_baseAttack(baseAttack), m_baseDefense(baseDefense)
	{
	}
